...
function generateFilterContent(filterType) {
  ...
  if (filterType === 'class') {
    ...
    content += `<label><input type="checkbox" onchange="filterCars('0-20000')"> $0 - $10,000</label><br/>
                <label><input type="checkbox" onchange="filterCars('10000-20000')"> $10,001 - $20,000</label><br/>
